...
<head>
    ...
    <title>Error {{ $exception->getStatusCode() ?? '500' }} - bycolor.es</title>
    <meta name="description" content="Ha ocurrido un error temporal. Vuelve al inicio de bycolor.es">
...
<body class="bg-gradient-to-br from-gray-900 via-black to-gray-900 min-h-screen overflow-hidden relative">
    ...
    <div class="absolute inset-0">
        <div class="absolute top-10 left-10 text-8xl text-red-500 opacity-10 font-black transform rotate-12">{{ $exception->getStatusCode() ?? '500' }}</div>
        <div class="absolute top-32 right-20 text-6xl text-blue-500 opacity-10 font-black transform -rotate-12">ERROR</div>
        <div class="absolute bottom-20 left-32 text-7xl text-green-500 opacity-10 font-black transform rotate-45">TEMP</div>
        <div class="absolute bottom-32 right-10 text-5xl text-purple-500 opacity-10 font-black transform -rotate-45">OOPS</div>
    </div>
        ...
        <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="mb-8 sm:mb-12">
                <h1 class="text-4xl sm:text-6xl lg:text-7xl font-black text-white mb-4 sm:mb-6 leading-tight">
                    ⚠️ <span class="text-orange-400">ERROR</span> 
                    <span class="text-red-500">{{ $exception->getStatusCode() ?? '500' }}</span>
                </h1>
                <h2 class="text-2xl sm:text-4xl lg:text-5xl font-black text-gray-300 mb-6 sm:mb-8">
                    <span class="text-red-500">ALGO</span> 
                    <span class="text-blue-500">SALIÓ</span>
                    <span class="text-green-500">MAL</span>
                </h2>
                ...
                <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-8 border border-white/20 shadow-2xl">
                    <p class="text-lg sm:text-xl lg:text-2xl text-gray-300 leading-relaxed mb-6 sm:mb-8">
                        Ha ocurrido un error temporal en nuestro sistema. 
                        <span class="text-yellow-400 font-black">Nuestro equipo ya está trabajando en solucionarlo</span>. 
                        <br class="hidden sm:block">
                        Mientras tanto, puedes volver al inicio y conocer todos nuestros servicios.
                    </p>
            ...
            <div class="mt-8 sm:mt-12">
                <p class="text-gray-400 text-sm sm:text-base mb-4">¿Necesitas ayuda urgente?</p>
                <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                    ...
                    <a href="https://wa.me/34600646123?text=Hola%20bycolor,%20he%20encontrado%20un%20error%20en%20la%20web" target="_blank" class="flex items-center space-x-2 text-green-400 hover:text-green-300 transition-colors">
                        <span>📱</span>
    ...
    <a href="https://wa.me/34600646123?text=Hola%20bycolor,%20he%20encontrado%20un%20error%20en%20la%20web" 
